      ...
      <div className="container-page">
        ...
        <div className="text-center mb-12 fade-in">
          ...
          <p className="text-xl text-gray-200 mb-8">
            Anonymous moments from people around the world
          </p>
          ...
          {newPostsCount > 0 && (
            <div className="inline-block glass rounded-full px-6 py-2 border-2 border-green-400/50 bg-green-500/20 animate-pulse">
              <span className="text-white font-semibold">
                ✨ {newPostsCount} new {newPostsCount === 1 ? 'moment' : 'moments'} shared!
              </span>
            </div>
          )}
        </div>
        ...
        {posts.length === 0 && (
          <div className="text-center py-20">
            <div className="glass rounded-3xl p-12 max-w-2xl mx-auto">
              ...
              <h2 className="text-3xl font-bold text-white mb-4">No Moments Yet</h2>
              <p className="text-gray-200 mb-8">
                Be the first to share a moment anonymously!
              </p>
              <Link
                href="/upload"
